...
const migrations = [
  ["Privacy-Policy.tsx", "privacy-policy.tsx", "/Privacy-Policy", "/privacy-policy"],
  ["Terms&Conditions.tsx", "terms-and-conditions.tsx", "/Terms&Conditions", "/terms-and-conditions"],
  ["Return-Policy.tsx", "return-policy.tsx", "/Return-Policy", "/return-policy"],
  ["Refund-Policy.tsx", "refund-policy.tsx", "/Refund-Policy", "/refund-policy"],
  ["Shipping-Delivery.tsx", "shipping-delivery.tsx", "/Shipping-Delivery", "/shipping-delivery"],
...
for (const [oldName, newName, oldPath, newPath] of migrations) {
  ...
  for (const from of [oldPath, oldPath.replace("&", "&")]) {
    content = content.replace(`createFileRoute("${from}")`, `createFileRoute("${newPath}")`);
  }
