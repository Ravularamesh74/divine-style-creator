    ...
    <main className="overflow-hidden bg-background text-foreground">
      <section className="relative isolate border-b border-border px-6 py-24 md:py-32">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <a
              href="https://wa.me/916309376811?text=Hi%20Style%20Daddy%2C%20I%20have%20a%20question."
              target="_blank"
              rel="noreferrer"
      ...
      <section className="px-6 py-20">
        <div className="mx-auto grid max-w-7xl gap-6 md:grid-cols-3">
          <a
            href="https://wa.me/916309376811?text=Hi%20Style%20Daddy%2C%20I%20need%20help."
            target="_blank"
            rel="noreferrer"
